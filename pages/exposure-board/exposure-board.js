Page({
  data: {
    ...
    list: [
      {
        id: 1, date: '2026-02-05', type: '虚假信息', avatarText: '虚', avatarColor: '#F43F5E',
      ...
      {
        id: 2, date: '2026-02-01', type: '欠薪欠款', avatarText: '欠', avatarColor: '#F97316',
        company: '***五金加工厂', contact: '', amount: '¥12,800',
        reason: '拖欠临工工资超过30天未支付，涉及8名临工，多次催促仍未解决。',
        images: ['https://picsum.photos/seed/eb2a/300/300', 'https://picsum.photos/seed/eb2b/300/300'],
        comments: 12
      },
      {
        id: 3, date: '2026-01-28', type: '欺诈行为', avatarText: '欺', avatarColor: '#6366F1',
        company: '', contact: '张**', amount: '¥5,200',
