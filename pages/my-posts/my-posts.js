    ...
    posts: [
      {
        ...
        status: 'published', statusText: '已发布', statusColor: 'green',
      ...
      },
      {
        ...
        status: 'reviewing', statusText: '待审核', statusColor: 'amber',
      ...
      },
      {
        ...
        status: 'rejected', statusText: '已驳回', statusColor: 'rose',
      ...
      },
      {
        ...
        status: 'offline', statusText: '已下架', statusColor: 'gray',
      ...
      },
      {
        ...
        status: 'pending_settlement', statusText: '待结算', statusColor: 'amber',
      ...
      },
      {
        ...
        status: 'published', statusText: '招工中', statusColor: 'green',
