Page({
  data: {
    ...
    systemMessages: [
      ...
      { id: 's2', icon: '👁', iconBg: '#ECFDF5', borderColor: '#10B981', title: '有人查看了您的联系方式', desc: '***电子科技 查看了您「保温杯3000个采购」的联系方式。', time: '30分钟前', unread: true },
      { id: 's3', icon: '⏰', iconBg: '#FFF7ED', borderColor: '#F97316', title: '出勤确认提醒', desc: '您报名的「鑫达电子厂·电子组装工」明天开工，请在今天18:00前确认出勤。', time: '2小时前', unread: true },
      ...
      { id: 's4', icon: '💰', iconBg: '#FFFBEB', borderColor: '', title: '工资已到账', desc: '顺丰物流仓·包装工 工资¥1,152已发放至您的钱包。', time: '昨天', unread: false },
