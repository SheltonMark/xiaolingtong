Page({
  data: {
    ...
    workerFuncs: [
      ...
      { icon: '\ue624', label: '灵豆商城', bg: '#FFFBEB', iconColor: '#F59E0B', url: '/pages/bean-recharge/bean-recharge' },
      ...
      { icon: '\ue8a0', label: '工作记录', bg: '#FFF1F2', iconColor: '#F43F5E', url: '/pages/work-record/work-record' }
    ]
  },
